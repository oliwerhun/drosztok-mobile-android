...
export default function VClassOrdersTab() {
  ...
  // Permissions:
  // Admin: create, read, update, delete, reorder
  // User: read, delete
  const isRealAdmin = userProfile?.role === 'admin';
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { backgroundColor: colors.locationHeader }]}>
        <Text style={styles.headerText}>Rendelések</Text>
        {isRealAdmin && (
